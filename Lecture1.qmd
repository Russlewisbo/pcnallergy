...
## Penicillin and Antibiotic Allergies {background-color="#9B0014"}
...
<br> {{< fa solid envelope size=1x >}} russelledward.lewis\@unipd.it <br> {{< fa brands github size=1x >}} https://github.com/Russlewisbo<br> Slides and course materials: [www.padovaid.com](https://padovaid.com/)
...
# SCAR: Severe Cutaneous Adverse Reactions {background-color="#9B0014"}
...
# Penicillin allergy {background-color="#9B0014"}
...
## Penicillin skin test assessment <br> -Medium risk history {.smaller}
...
![](images/Sanford.png){fig-align="center" width="200"}
...
## CEPHTEST: Application of PENFAST <br> score to cephalosporin allergies

![](images/cephfast.png){fig-align="center"}
...
# Non-penicillin allergies {background-color="#9B0014"}
...
## Intradermal testing-Non beta-lactams {.smaller}
...
## Approach to delayed-type <br> hypersensitivity testing
